...
const AntdLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    {...props}
...
const GoogleSheetsLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    fill="#00ab47"
    viewBox="0 0 24 24"
    role="img"
...
const EmotionLogo = (props: React.ImgHTMLAttributes<HTMLImageElement>) => (
  <div className="w-[1em] h-[1em] mr-2 relative">
    <Image
      src="/about/career/EmotionLogo.png"
      alt="Emotion"
      fill
...
const SCSSLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 32 32"
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
...
export const TECHS = {
  ...
  googlesheets: {
    label: "Google Sheets",
    className: "bg-[#00ab47] text-[#FFF] border border-[#00ab47]",
    Icon: GoogleSheetsLogo,
    href: "https://www.google.com/sheets",
  },
  postgres: {
    label: "PostgreSQL",
